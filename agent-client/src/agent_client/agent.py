...
SYSTEM_PROMPT = (
    ...
    "  a. Identify the user's attributes (OU, JOBTITLE, CITY, AREANAME, "
    "SEGMENTNAME, etc.). Ask the user if they don't provide them.\n"
    "  b. Use filter_dataset on Entitlements with the attributes the user "
    "provided (e.g. {\"OU\": \"...\", \"JOBTITLE\": \"...\"}).\n"
    "  c. If too few results, broaden the filter: try ParentOU instead of "
    "OU, or drop JOBTITLE and filter by SEGMENTNAME or AREANAME alone.\n"
