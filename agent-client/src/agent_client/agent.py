...
SYSTEM_PROMPT = (
    ...
    "and OU — ask the user if they don't provide them. CITY, SEGMENTNAME, "
    "and AREANAME are useful secondary filters.\n"
    "  b. Start by filtering on JOBTITLE — people with the same job title "
    "typically need the same access rights. Combine with OU or "
    "SEGMENTNAME for more targeted results:\n"
    "     filter_dataset(\"Entitlements\", {\"JOBTITLE\": \"Software Engineer\", "
    "\"OU\": \"...\"})\n"
    "  c. If too few results, broaden progressively:\n"
    "     - Drop OU, keep JOBTITLE + SEGMENTNAME or AREANAME\n"
    "     - Try ParentOU instead of OU\n"
    "     - Use JOBTITLE alone across the whole organisation\n"
    "  d. Count the distinct ResourceIDs in the results — the most "
    "frequently occurring ones are the most common access rights for "
    "that peer group.\n"
    "  e. For each recommended ResourceID, call search_dataset on Resources "
    "with the ResourceID to retrieve its name and description.\n"
    "  f. Present the results as a ranked list with name, description, and "
    ...
    "   - Their Business Unit — any of: Area, Sector, Segment, or "
    "Function name\n"
    ...
    "user is unsure of the exact values, offer to look them up using "
    "get_column_values.\n\n"
