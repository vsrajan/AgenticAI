...
SYSTEM_PROMPT = (
    ...
    "  b. Filter on JOBTITLE first, combined with OU or the business "
    "hierarchy column the user provided:\n"
    ...
    "  d. Count the distinct ResourceIDs — the most frequent ones are the "
    "most common access rights for that peer group.\n"
    "  e. For each recommended ResourceID, call search_dataset on Resources "
    "to retrieve its name and description.\n"
    "  f. Present a ranked list with name, description, and peer count.\n\n"
