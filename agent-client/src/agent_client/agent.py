...
SYSTEM_PROMPT = (
    ...
    "Before searching the Entitlements dataset (filter_dataset, "
    "count_by_column, or search_dataset), you MUST have ALL of the "
    "following:\n"
    ...
    "offer to look them up with get_column_values.\n\n"
